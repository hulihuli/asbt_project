  ...
  $.fn.extend({
    ...
    loadStep: function(params){
      ...
      var baseHtml =  "<div class='ystep_container'>"+
                        ...
                        "</ul>"+
                        "<div class='ystep_progress'>"+
                          "<p class='ystep_progress_bar'>"+
                            "<span class='ystep_progress_highlight' style='width:0%'>"+
                            "</span>"+
                          "</p>"+
                        "</div>"+
                      "</div>";
      ...
      $(this).each(function(i,n){
        ...
        $n.append($baseHtml);
        //渲染提示气泡
       // $n.find(".ystep_step").popover({});

		$n.find(".ystep_step").hover(function(){
			//hover code
    ...
    setStep: function(step) {
      $(this).each(function(i,n){
        ...
        var $progress =$(n).find(".ystep_container").find(".ystep_progress_highlight");
        //判断当前步骤是否在范围内
