	...
	Validform.util={
		...
		getNullmsg:function(curform){
			...
			if(label != ""){
				...
				nullmsg=obj.is(":checkbox,:radio,select,.model-select-box") ? nullmsg.replace(/\{0\|(.+)\}/,"") : nullmsg.replace(/\{0\|(.+)\}/,"$1");
			}
			nullmsg=obj.is(":checkbox,:radio,select,.model-select-box") ? nullmsg.replace(reg,"$2") : nullmsg.replace(reg,"$1");
